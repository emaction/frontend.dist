...
class EmojiReaction extends s {
  ...
  render() {
    ...
    <!-- container -->
    <div style="flex-wrap: nowrap; overflow-x: scroll; max-width: 100%; display: flex; gap: 0.375rem;" class="${this?.theme === 'dark' || (this?.theme === 'system' && system_theme === 'dark') ? 'container-dark' : 'container'}">
      <!-- 灰色笑脸 -->
